                        ...
                        for ($x = 0; $x < $sx; $x++)
                        {
                            for ($y = 0; $y < $sy; $y++)
                            {
								...
								*/
								...
								$rgb = imagecolorat($this->_img['orig'], $x, $y); ## Martin
								$r = ($rgb >> 16) & 0xFF; ## Martin
								$g = ($rgb >> 8) & 0xFF; ## Martin
								$b = $rgb & 0xFF; ## Martin
								$thres = $this->_pixelAlphaThreshold($this->_mask['gray'], $x, $y); 
								$pixelcoloralpha = imagecolorallocatealpha($this->_img['final'],$r,$g,$b,$thres); ## Martin
                                imagesetpixel($this->_img['final'], $x, $y, $pixelcoloralpha);  ## Martin 
        ...
        if ($this->_img['orig'])
        {
            ...
            if ($this->_img['final'])
            {
              ...
              //  imagecopyresampled($this->_img['final'], $this->_img['orig'], 0, 0, 0, 0, $isx, $isy, $isx, $isy);
                ...
                imagealphablending($this->_img['final'], false);  ## Martin
//                imagecopyresampled($this->_img['final'], $this->_img['orig'], 0, 0, 0, 0, $isx, $isy, $isx, $isy);  ## Martin
                                 $this->grey = imagecolorallocatealpha($this->_img['final'],55,55,55,75); ## Martin
                                imagefill($this->_img['final'],0,0,$this->grey); ## Martin
                                imagesavealpha($this->_img['final'], true); ## Martin 
